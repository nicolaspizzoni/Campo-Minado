...
const getNeighbors = (board, row, column) => {
    ...
    rows.forEach(r => {
        columns.forEach(c => {
            const different = r !== row || c !== column //verificando se r e c são iguais a linha e coluna passada, o par
...
// const putFlag = (board, row, column) => {
//     const field = board[row][column]
//     if(!field.flagged){
//         field.flagged = true
//     }
...
// const removeFlag = (board, row, column) => {
//     const field = board[row][column]
//     field.flagged = false
// }
